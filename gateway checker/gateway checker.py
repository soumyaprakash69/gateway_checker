...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7709177882:AAEbp3N9sKyENoQdOO2IzKbfjKV4ZtjN7Zg") # @botfather  
API_ID = os.environ.get("API_ID", "26954601") # my.telegram.org se milega
API_HASH = os.environ.get("API_HASH", "d276fb2b026897a91dcf3385683a5f9e") # my.telegram.org se milega
